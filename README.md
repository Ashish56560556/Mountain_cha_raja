...
<head>
    ...
    <style>
        ...
        @media (max-width: 600px) {
            .group-header { font-size: 2em; margin-top: 24px;}
            .glimpse-title { font-size: 1.3em; }
            .cta-btn { font-size: 1em; padding: 12px 18px;}
            .ganpati-img { max-width: 220px; }
            .glimpse-gallery {
        ...
        @media (max-width: 400px) {
            .group-header { font-size: 1.3em; }
            .glimpse-title { font-size: 1em; }
            .cta-btn { font-size: 0.9em; padding: 8px 10px;}
            .ganpati-img { max-width: 120px; }
            .glimpse-caption { font-size: 0.9em;}
        }
    </style>
</head>
<body>
